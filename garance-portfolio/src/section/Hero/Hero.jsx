...
export default function Hero() {
  return (
    <section className="bg-martinique-50 dark:bg-martinique-950 pt-24 mx-auto px-4 items-center lg:flex md:px-8 text-center">
      <div className="space-y-4 flex-1 text-center sm:text-center">
        ...
        <div className="pt-3 items-center justify-center space-y-3 sm:space-y-0 lg:justify-start">
